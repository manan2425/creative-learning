      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {filteredPracticals.length === 0 ? (
          <div className="bg-white rounded-3xl border border-border p-12 text-center space-y-3 shadow-2xs">
            ...
            <h4 className="font-bold text-navy text-base">No Practical Labs Listed Yet</h4>
            <p className="text-xs text-secondary max-w-sm mx-auto">
              Guided labs and experiments can be added directly via the Admin Dashboard.
            </p>
            <a
              href="/admin"
